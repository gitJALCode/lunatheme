...
Route::prefix('/account')->middleware(AccountSubject::class)->group(function () {
    ...
    // Luna theme: custom avatar upload.
    Route::post('/avatar', [Client\AvatarController::class, 'store']);
    Route::delete('/avatar', [Client\AvatarController::class, 'delete']);
});

/*
|--------------------------------------------------------------------------
| Server Folders (Luna theme)
|--------------------------------------------------------------------------
|
| Endpoint: /api/client/folders
|
*/
Route::prefix('/folders')->group(function () {
    Route::get('/', [Client\FolderController::class, 'index']);
    Route::post('/', [Client\FolderController::class, 'store']);
    Route::patch('/{folder}', [Client\FolderController::class, 'update']);
    Route::delete('/{folder}', [Client\FolderController::class, 'delete']);
    Route::put('/{folder}/servers', [Client\FolderController::class, 'setServers']);
});
