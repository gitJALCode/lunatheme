    ...
    Identifiable
{
    ...
    public function toVueObject(): array
    {
        return Collection::make($this->toArray())->except(['id', 'external_id'])
            ->merge([
                ...
                'avatar' => $this->avatar ? \Illuminate\Support\Facades\Storage::disk('public')->url($this->avatar) : null,
            ])
            ->toArray();
    }
    ...
    /**
     * Returns the server folders (Luna theme) that belong to this user.
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Pterodactyl\Models\ServerFolder, $this>
     */
    public function serverFolders(): HasMany
    {
        return $this->hasMany(ServerFolder::class);
    }
